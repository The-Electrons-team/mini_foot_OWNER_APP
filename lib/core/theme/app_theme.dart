...
ThemeData get appTheme => ThemeData(
  ...
  textTheme: const TextTheme(
    ...
    bodyLarge: TextStyle(color: kTextPrim, fontSize: 16, height: 1.5),
    bodyMedium: TextStyle(color: kTextSub, fontSize: 14, height: 1.5),
    bodySmall: TextStyle(color: kTextLight, fontSize: 12, height: 1.5),
    labelLarge: TextStyle(color: kTextPrim, fontSize: 14, fontWeight: FontWeight.w600),
  ),

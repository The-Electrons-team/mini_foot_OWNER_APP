...
class RevenuesScreen extends GetView<RevenuesController> {
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.bar_chart_rounded, size: 18, color: kGreen),
                ),
                const SizedBox(width: 10),
                const Text(
                  'Revenus',
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchCallback: (event, response) {
                      if (event is FlTapUpEvent &&
                        ...
                        controller.selectBar(response!.spot!.touchedBarGroupIndex);
                      }
                    },
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.show_chart_rounded, size: 18, color: kGold),
                ),
                const SizedBox(width: 10),
                const Text(
                  'Taux d\'occupation',
  ...
  Widget _buildTopPerformers() {
    final terrains = [
      ('Terrain Alpha', 345000, 0.82),
      ('Terrain Beta',  280000, 0.67),
      ('Terrain Omega', 190000, 0.45),
    ];
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.stadium_rounded, size: 18, color: kBlue),
                ),
                const SizedBox(width: 10),
                const Text(
                  'Par terrain',
            ...
            ...terrains.asMap().entries.map((e) {
              final (name, amount, rate) = e.value;
              final rank = e.key + 1;
              return Padding(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          '${controller.formatAmountFull(amount)} F',
                          style: const TextStyle(
                            fontSize: 13,
                            fontWeight: FontWeight.w700,
                            color: kTextPrim,
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 11,
                            color: rate >= 0.7 ? kGreen : kTextSub,
                            fontWeight: FontWeight.w600,
                          ),
                        ),
                      ],
    ...
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Get.to(() => const ReportScreen(), arguments: {
